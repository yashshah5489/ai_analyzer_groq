...
def insert_book_learnings():
    """
    Insert learnings from the top 25 self-help finance books into the ChromaDB collection.
    """
    book_learnings = [
    ...
    # Initialize the self-help book vector store
    vector_store = ChromaVectorStore(collection_name="self_help_books")
    
    # Generate unique IDs for each learning
